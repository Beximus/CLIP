...
# adapted from clip-try.py to do more pictures at once
...
def main():
    ...
    # This is where I start changing things
    import glob
    ...
    for picture in imagesToProcess:
        ...
        if len(imagenet_classes) > 1000:
            print("Scores for provided labels")
    ...
    # for t in sorted(glob.glob(args.input_glob)):
    #     image = preprocess(Image.open(t)).unsqueeze(0).to(device)
